...
- **UART:** 115200 Baud, 1024-byte Ring Buffer
- **IMU:** QMI8658 (Accel/Gyro) & MMC5603 (Mag)
- **IIC Driver:** [mikewen/AC6329_IIC](https://github.com/mikewen/AC6329_IIC) 
...
| 12-13| Heading | u16 | Degrees / 100 (0-360.00) |
...
public void onBleDataReceived(byte[] data) {
    ...
    switch (header) {
        case 0xA1: // IMU Data
            ...
            short gz = buffer.getShort(12);
            short mz = buffer.getShort(18);
            // Process IMU...
            break;
